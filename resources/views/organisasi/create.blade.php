...
@enderror
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control @error('leader_name') is-invalid @elseif(old('leader_name')) is-valid @enderror" id="leader_name" name="leader_name" value="{{ old('leader_name') }}"> @error('leader_name')
    <div class="invalid-feedback">{{ $message }}</div>
@enderror
